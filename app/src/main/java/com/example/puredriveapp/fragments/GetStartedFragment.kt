...
class GetStartedFragment : Fragment() {
    ...
    private lateinit var getStartedCommunicator: GetStartedCommunicator
    ...
    override fun onCreateView(
        ...
        getStartedCommunicator = activity as GetStartedCommunicator

        view.ibtnGetStarted.setOnClickListener {
            getStartedCommunicator.loadNextFragment(R.id.frameGetStarted, ChooseUserFragment())
        }
